...
% error('Tracker not configured! Please edit the tracker_DADR.m file.'); % Remove this line after proper configuration
...
tracker_command = generate_matlab_command('vot_wrapper', {'/mnt/duming/data-sets-tracking/vot-trackers/dadrt/'});
